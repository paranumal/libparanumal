...
lc   = DefineNumber[0.04];
lc2  = DefineNumber[0.40];
lc3  = DefineNumber[0.50];
...
Point(10) = {9.801469e-01,0.000000e+00,-2.781989e-03,fac*lc};
...
Point(70) = {2.189592e-01,0.000000e+00,-5.790876e-02, fac*lc};
Point(71) = {2.061082e-01,0.000000e+00,-5.729925e-02, fac*lc};
Point(72) = {1.935473e-01,0.000000e+00,-5.658907e-02, fac*lc};
Point(73) = {1.812888e-01,0.000000e+00,-5.577839e-02, fac*lc};
Point(74) = {1.693449e-01,0.000000e+00,-5.486767e-02, fac*lc};
...
Point(116) = {5.449721e-02,0.000000e+00,3.667711e-02,fac*lc};
Point(117) = {6.184718e-02,0.000000e+00,3.865567e-02,fac*lc};
Point(118) = {6.962952e-02,0.000000e+00,4.055926e-02,fac*lc};
Point(119) = {7.783660e-02,0.000000e+00,4.238483e-02,fac*lc};
Point(120) = {8.646032e-02,0.000000e+00,4.412942e-02,fac*lc};
...
yomin   = DefineNumber[-4.0];
yomax   = -yomin; 
xomin   = DefineNumber[4.0];
...
// Internal region
Point(806) = { xi, -yi,  0.0,   0.5*lc2}; 
Point(807) = { xi,  yi,  0.0,   0.5*lc2}; 
Point(808) = { -yi,  0.0,  0.0, 0.5*lc2}; 
...
Curve Loop(2) = {8, 9, 10, 11, 5, 6, -12, -15, -14, 13};
Plane Surface(1) = {2};
Curve Loop(3) = {7, -13, 14, 15, 12};
Plane Surface(2) = {1, 3};
...
Extrude {0, 0, 1} { Surface{2}; Surface{1};}
// Extrude {0, 0, 1} {Surface{2};}
// Delete {Volume{2};}
