...
Physical Surface("Wall",1) = {158, 154, 150};
Physical Surface("Inflow",2) = {176, 50};
Physical Surface("Outflow",3) = {116, 98};
Physical Surface("YSlip",5) = {94, 76, 54, 180, 162, 146, 112};
Physical Surface("ZSlip",6) = {99, 121, 185, 55, 27, 31, 33, 25, 77, 163, 23, 29};
