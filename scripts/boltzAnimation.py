#### boltzAnimation.py
####   usage: pvbatch boltzAnimation.py 1 ../examples/cnsTri2D/foo foo
...
for n in range(0,Ndatasets):
  ...
  dataset[n].PointArrayStatus = ['Pressure', 'Velocity', 'Vorticity']
...
groupDatasets1Display.OSPRayScaleArray = 'Pressure'
groupDatasets1Display.OSPRayScaleFunction = 'PiecewiseFunction'
groupDatasets1Display.SelectOrientationVectors = 'Pressure'
groupDatasets1Display.ScaleFactor = 1.6
groupDatasets1Display.SelectScaleArray = 'Pressure'
groupDatasets1Display.GlyphType = 'Arrow'
groupDatasets1Display.GlyphTableIndexArray = 'Pressure'
groupDatasets1Display.DataAxesGrid = 'GridAxesRepresentation'
groupDatasets1Display.PolarAxes = 'PolarAxesRepresentation'
groupDatasets1Display.ScalarOpacityUnitDistance = 0.13782327363324953
groupDatasets1Display.GaussianRadius = 0.8
groupDatasets1Display.SetScaleArray = ['POINTS', 'Pressure']
groupDatasets1Display.ScaleTransferFunction = 'PiecewiseFunction'
groupDatasets1Display.OpacityArray = ['POINTS', 'Pressure']
...
# set scalar coloring
ColorBy(groupDatasets1Display, ('POINTS', 'Vorticity', 'X'))
