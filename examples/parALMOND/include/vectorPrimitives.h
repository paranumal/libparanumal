...
void kcycleCombinedOp1(int n, dfloat *aDotbc, dfloat *a, dfloat *b, dfloat *c, dfloat *w, bool weighted);

void kcycleCombinedOp2(int n, dfloat *aDotbcd, dfloat *a, dfloat *b, dfloat *c, dfloat* d, dfloat *w, bool weighted);

void vectorAdd(int n, dfloat alpha, dfloat *x, dfloat beta, dfloat *y);

dfloat vectorAddInnerProd(int n, dfloat alpha, dfloat *x, dfloat beta, dfloat *y, dfloat *w, bool weighted);
