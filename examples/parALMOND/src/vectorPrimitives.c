...
void kcycleCombinedOp1(iint n, dfloat *aDotbc, dfloat *a, 
...
void kcycleCombinedOp2(iint n, dfloat *aDotbcd, dfloat *a, dfloat *b, 
...
// returns aDotbc[0] = a\dot b, aDotbc[1] = a\dot c, aDotbc[2] = b\dot b,
void kcycleCombinedOp1(parAlmond_t *parAlmond, iint N, dfloat *aDotbc, 
...
// returns aDotbcd[0] = a\dot b, aDotbcd[1] = a\dot c, aDotbcd[2] = a\dot d,
void kcycleCombinedOp2(parAlmond_t *parAlmond, iint N, dfloat *aDotbcd, 
                        occa::memory o_a, occa::memory o_b, 
