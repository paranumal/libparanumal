...
int main(int argc, char **argv){
 ...
 // start up MPI
  ...
  char *prSolverOptions =
    strdup("solver=PCG,FLEXIBLE,VERBOSE method=IPDG preconditioner=FULLALMOND"); // ,FORCESYMMETRY"); // ,FORCESYMMETRY");
  ...
  ins_t *ins = insSetupQuad2D(mesh,options,velSolverOptions,prSolverOptions,boundaryHeaderFileName);
