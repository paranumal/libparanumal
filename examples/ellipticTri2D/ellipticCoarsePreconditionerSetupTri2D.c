...
void ellipticBuildCoarseIpdgTri2D(mesh2D *mesh, dfloat tau, dfloat lambda, int *BCType, nonZero_t **A,
                              int *nnzA, int *globalStarts, const char *options);

void ellipticBuildCoarseContinuousTri2D(mesh2D *mesh, dfloat lambda, nonZero_t **A, int *nnz,
