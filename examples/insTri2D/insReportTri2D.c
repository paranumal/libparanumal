...
void insReportTri2D(ins_t *ins, int tstep, char *options){
  ...
  // gather-scatter
  ellipticParallelGatherScatterTri2D(mesh, mesh->ogs, ins->o_Vort, dfloatString, "add");  
