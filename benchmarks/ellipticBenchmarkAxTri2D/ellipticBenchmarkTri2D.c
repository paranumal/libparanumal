...
int main(int argc, char **argv){
  ...
  if(argc<4){
    printf("usage 1: ./ellipticBenchmark2D kernel.okl ../../meshes/cavityH005.msh N\n");
    printf("usage 2: ./ellipticBenchmark2D kernel.okl ../../meshes/cavityH005.msh N Nblocks Nnodes\n");
    exit(-1);
  }
